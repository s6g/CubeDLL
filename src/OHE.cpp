...
__asm
	...
	oneHit:
		...
		cmp [ebx + TeamOffset], ecx  //compare the player team with mine
		pop ecx //thank you
		je returnJump //if he IS in my team, Jump Back (dont subtract)
		push ecx //appparently he's not
		mov ecx, [ebx + healthOffset] //take his health
		sub [ebx + healthOffset], ecx //subtract his health by his health -> 0
		pop ecx//thank you
		jmp returnJump //Jump Back

	normal:
		sub [ebx + healthOffset], edi  //stolen byte (normal function)
